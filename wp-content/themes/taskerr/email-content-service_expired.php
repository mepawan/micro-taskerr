<?php
/**
 * Service Expired email template
 *
							...
							<td style="margin: 0; padding: 0;">
								...
								<div class="email-content" style="<?php echo $tr_fonts; ?> font-weight: normal; font-size: 14px; line-height: 1.6; margin: 0; padding: 0;">
									...
									<p class="lead" style="<?php echo $tr_fonts; ?> font-weight: normal; font-size: 17px; line-height: 1.6; margin: 0 0 10px; padding: 0;">
										<?php _e( 'Your service listing has expired and is no longer publicly visible.', APP_TD ); ?>
									</p>
									<!-- /Lead Text -->
									...
									<p>
										...
										<a href="<?php echo esc_url( tr_get_service_renew_url( $service->ID ) ); ?>" class="btn" style="<?php echo $tr_fonts; ?> text-decoration: none; color: #FFF; background-color: #666; padding: 10px 16px; font-weight: bold; margin-right: 10px; text-align: center; cursor: pointer; display: inline-block;">
											<?php _e( 'Relist Service', APP_TD ); ?>
										</a>
									</p>
									<!-- /Callout Panel -->
