<?php
/**
 * A Task action email template for Buyer
 *
								...
								<div class="email-content" style="<?php echo $tr_fonts; ?> font-weight: normal; font-size: 14px; line-height: 1.6; margin: 0; padding: 0;">
									...
									<p class="lead" style="<?php echo $tr_fonts; ?> font-weight: normal; font-size: 17px; line-height: 1.6; margin: 0 0 10px; padding: 0;">
										...
										<?php switch( $task_action ) {
											...
											case 'created':
												_e( 'Your task was successfully submitted.', APP_TD );
												break;

											case 'paid':
												_e( 'Service Provider marked your task as "Paid".', APP_TD );
												echo '<br />';
												_e( "You'll be notified once it is completed.", APP_TD );
												break;

											case 'unpaid':
												_e( 'Service Provider marked your task as "Unpaid".', APP_TD );
												echo '<br />';
												_e( 'Contact Provider to resolve this problem.', APP_TD );
												break;

											case 'complete':
												_e( 'Service Provider marked your task as "Completed".', APP_TD );
												echo '<br />';
												_e( 'If you agree that it has been completed, please mark it as "Confirmed."', APP_TD );
												break;

											case 'uncomplete':
												_e( 'Service Provider marked your task as "Uncompleted".', APP_TD );
												echo '<br />';
												_e( 'Contact Provider to resolve this problem.', APP_TD );
												break;

											case 'confirm':
												_e( 'You have marked your task as "Confirmed".', APP_TD );
												break;

											case 'unconfirm':
												_e( 'You have marked your task as "Unconfirmed".', APP_TD );
												break;
									...
									<!-- Callout Panel -->
									<p>
										<a href="<?php echo esc_url( tr_get_dashboard_purchased_url() ); ?>" class="btn" style="<?php echo $tr_fonts; ?> text-decoration: none; color: #FFF; background-color: #666; padding: 10px 16px; font-weight: bold; margin-right: 10px; text-align: center; cursor: pointer; display: inline-block;">
